...
func main() {
	...
	outsourcedSolution := assignment2.CreateOutsourcedSolution(data)

	obj, solution := heuristics.RandomSearch(data, outsourcedSolution)

	fmt.Printf("Objective: %v %v", obj, solution)
}
